...
public class StaticShader extends ShaderProgram{
	...
	public void loadPBR() {
		...
		super.loadVector(location_albedo, new Vector3f(albedoR,albedoG,albedoB));
		super.loadFloat(location_metallic, 0+metallic);
		super.loadFloat(location_roughness, 0+roughness);
		super.loadFloat(location_ao, ao);
		super.loadVector(location_lightPosition, new Vector3f(lightX,lightY,lightZ));
